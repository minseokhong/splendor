    ...
    <div class="container radius"
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <h2 style="color:rgb(151, 137, 137); text-align: center; padding: 15px;"> 글 수정</h2>
                <form action="write_ok.jsp" method="post" encType="multiplart/form-data">
                    ...
                    <tr>
                        <th> <input type="button" value="수정완료"
                                style=" width:100px; background-color: dodgerblue; border-radius: 5px;border: 0; outline: 0; color: white"
                                ; onclick="alert('수정완료'); location.href='clicktopost.html'" class="pull-right large" />
