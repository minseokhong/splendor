				...
				<div class="row">
					<div class="col-lg-6">
						<div class="home_left_img">
                            ...
                            <ul class="home_info">
                                <li class="home_info2"><h1>닉네임 : </h1><h2>윤현빈</h2></li>
                                <li class="home_info2"><h1>랭킹 : </h1><h2>54위</h2></li>
                                <li class="home_info2"><h1>전적 : </h1><h2>4승2패</h2></li>
                                <li class="home_info2"><h1>길드명 : </h1><h2>R.N.G</h2></li>
<!--                                 <li class="home_info2"><h1>길드 랭킹 : </h1><h2>45위</h2></li> -->
                                <li class="home_info2"><h1>길드 랭킹 : </h1><h2>${key } ${value }</h2></li>
